...
<html lang="en">
  ...
  <body style="background-color: rgb(255, 255, 224)">
    ...
    <p>
      ...
      grew. All grown-ups were once children - although few of them remember it.
    ...
    <p>
      ...
      called <i>True Stories from Nature</i>, about the primeval forest. It was
      a picture of a boa constrictor in the act of swallowing an animal. Here is
    ...
    <p>
      In the book it said:
      <em
        >"Boa constrictors swallow their prey whole, without chewing it. After
        that they are not able to move, and they sleep through the six months
        that they need for digestion."</em
      >
    </p>
    <p>
    ...
    <p>
      But they answered:
      <em>"Frighten? Why should any one be frightened by a hat?"</em>
    </p>
    <p>
      ...
      constrictor, so that the grown-ups could see it clearly. They always need
    ...
    <p>
      ...
      Number One and my Drawing Number Two. Grown-ups never understand anything
      by themselves, and it is tiresome for children to be always and forever
      explaining things to them.
    </p>
    <p>
      So then I chose another profession, and learned to pilot airplanes. I have
      flown a little over all parts of the world; and it is true that geography
      has been very useful to me. At a glance I can distinguish China from
    ...
    <p>
      ...
      lived a great deal among grown-ups. I have seen them intimately, close at
    ...
    <p>
      ...
      all alone. It was a question of life or death for me: I had scarcely
    ...
    <p>
      ...
      person, who stood there examining me with great seriousness. Here you may
      see the best portrait that, later, I was able to make of him. But my
    ...
    <p>
      ...
      miles from any inhabited region. And yet my little man seemed neither to
      be straying uncertainly among the sands, nor to be fainting from fatigue
      or hunger or thirst or fear. Nothing about him gave any suggestion of a
    ...
    <p>
      ...
      might seem to me, a thousand miles from any human habitation and in danger
      of death, I took out of my pocket a sheet of paper and my fountain-pen.
      But then I remembered how my studies had been concentrated on geography,
      history, arithmetic and grammar, and I told the little chap (a little
    ...
    <p>
      ...
      had drawn so often. It was that of the boa constrictor from the outside.
    ...
    <img
      src="http://users.uoa.gr/~nektar/arts/tributes/antoine_de_saint-exupery_le_petit_prince/images/nemocnyBeranek.jpg"
      alt="nemocnyBeranek"
    />
    ...
    <img
      src="http://users.uoa.gr/~nektar/arts/tributes/antoine_de_saint-exupery_le_petit_prince/images/Beran.jpg"
      alt="Beran"
    />
    <p>My friend smiled gently and indulgently.</p>
    <p>
      <em>"You see yourself,"</em> he said,
      <em>"that this is not a sheep. This is a ram. It has horns."</em>
    </p>
    <p>So then I did my drawing over once more.</p>
    <p>But it was rejected too, just like the others.</p>
    <p>
      <em>"This one is too old. I want a sheep that will live a long time."</em>
    </p>
    <img
      src="http://users.uoa.gr/~nektar/arts/tributes/antoine_de_saint-exupery_le_petit_prince/images/staryBeranek.jpg"
      alt="staryBeranek"
    />
    <p>
    ...
    <img
      src="http://users.uoa.gr/~nektar/arts/tributes/antoine_de_saint-exupery_le_petit_prince/images/krabice.jpg"
      alt="krabice"
    />
    ...
    <img
      src="http://users.uoa.gr/~nektar/arts/tributes/antoine_de_saint-exupery_le_petit_prince/images/princSala.jpg"
      alt="princSala"
    />
    ...
    <p>
      ...
      the <em>"other planets."</em> I made a great effort, therefore, to find
    ...
    <img
      src="http://users.uoa.gr/~nektar/arts/tributes/antoine_de_saint-exupery_le_petit_prince/images/malyPrincHvezdy.jpg"
      alt="malyPrincHvezdy"
    />
    ...
    <p>
      <em> "That doesn't matter. Where I live, everything is so small!" </em>
    </p>
